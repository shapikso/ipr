...
const bigGardClasses = 'pt-[86px] pb-[83px] bg-button-bg text-white';

const PricingTab = ({pricingType, pricingFeature, price, bigCard}: IProps) => {
    return (
        <div className={`flex flex-col justify-center items-center max-w-[335px] rounded-[10px] w-full ${bigCard ? bigGardClasses : cardClasses }`}>
            ...
            <div className='flex gap-[10px] justify-center items-center mt-[29px]'>
            ...
            <div className='flex flex-col gap-[20px] justify-center items-center mt-[29px]'>
                {pricingFeature.map((item,index) => <p key={index}>{item}</p>)}
            </div>
